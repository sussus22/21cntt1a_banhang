						...
						<div class="cart">
							...
							@isset($productCarts)
								@foreach($productCarts as $product)
									<div class="cart-item">
										<a class="cart-item-delete" href="{{route('banhang.delToCart',$product['item']->id)}}">
											<i class="fa fa-times"></i>
										</a>
										<div class="media">
											<a class="pull-left" href="#"><img src="/source/image/product/{{$product['item']->image}}" width="50" height="50"alt=""></a>
											<div class="media-body">
												<span class="cart-item-title">{{$product['item']['name']}}</span>
												<span class="cart-item-options">Size: XS; Color: Nacy</span>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						<li><a href="{{route('banhang.trangchu')}}">Trang chủ</a></li>
