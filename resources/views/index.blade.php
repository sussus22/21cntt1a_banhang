...
@section('content')
	...
	<div class="fullwidthtrangchuner-container">
									...
									<div class="col-sm-3">
										<div class="single-item">
											<div class="single-item-header">
												<a href="{{ route('trangchu.show',$new_product->id) }}"><img src="source/image/product/{{$new_product->image}}" width="270" height="320" alt=""></a>
											</div>
											...
											<div class="single-item-caption">
												...
												<a class="beta-btn primary" href="{{ route('trangchu.show',$new_product->id) }}">Details <i class="fa fa-chevron-right"></i></a>
												<div class="clearfix"></div>
											</div>
										</div>
									</div>
			...
			<div class="main-content">
                ...
                @foreach($products as $products) 
								...
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="product.html"><img src="source/image/product/{{$products->image}}" alt="" width="270" height="260"></a>
										</div>
										<div class="single-item-body">
